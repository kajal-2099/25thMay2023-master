...
public class Example4 {
	...
	public static void main(String[] args) {
		setUp("chrome", "https://www.espncricinfo.com/");
		List<WebElement> mainMenuList=driver.findElements(By.cssSelector(".ds-bg-fill-navbar>div>div>.ds-justify-between>*:first-child>div>a"));
